...
Esta pasta concentra a documentacao e a implementacao da Fulldev School, a experiencia frontend guiada do conteudo editorial deste repositorio.

## estrutura-atual

- `docs/`: visao do produto, arquitetura, stack, modelo de conteudo e estrategia de audio
