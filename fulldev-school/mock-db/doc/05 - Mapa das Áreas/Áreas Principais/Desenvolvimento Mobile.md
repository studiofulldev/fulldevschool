...
Criar um app de delivery, banco, agenda ou monitoramento pessoal.
...
1. roadmap.sh Android Roadmap. https://roadmap.sh/android
2. roadmap.sh iOS Roadmap. https://roadmap.sh/ios
