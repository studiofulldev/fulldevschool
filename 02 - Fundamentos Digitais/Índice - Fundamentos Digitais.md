...
- `Ctrl + X`: recortar
- `Ctrl + Z`: desfazer
- `Ctrl + F`: localizar texto na tela
- `Ctrl + T`: nova aba no navegador
...
| --- | --- | --- | --- |
| Computador, pastas e arquivos | Microsoft Support e GCFGlobal sobre sistema operacional, arquivos e navegação básica | 97% | É um bloco fortemente sustentado por fundamentos básicos e documentação estável. |
...
| Como pesquisar no Google | Boas práticas editoriais e suporte oficial de busca | 88% | É um bloco útil, mas mais orientativo do que normativo. |
