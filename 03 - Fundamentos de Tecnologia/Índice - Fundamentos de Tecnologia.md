...
**Próximo passo:** [[../04 - Como Aprender/Índice - Como Aprender|5 - Como Aprender]]
...
Esses dois termos aparecem o tempo todo.
...
É quem responde ou fornece um recurso.
...
É uma unidade específica de conteúdo.
...
É um conjunto de páginas conectadas.
...
É uma solução digital com regras, processos e funcionalidades mais amplas.
...
É um software voltado para uma tarefa ou conjunto de tarefas.
...
É contrato de comunicação entre partes de software.
...
É a parte com a qual a pessoa interage diretamente.
...
É a parte que processa regras, integrações e acesso a dados.
...
- fintechs
- e-commerces
- empresas tradicionais com time interno de tecnologia
...
| Site, página, sistema e aplicativo | Síntese editorial alinhada ao uso técnico comum | 88% | Útil e confiável, mas mais interpretativo. |
...
| Frontend e backend, em visão simples | Síntese editorial baseada na separação usual de responsabilidades | 89% | É didático, mas não cobre todos os modelos possíveis. |
